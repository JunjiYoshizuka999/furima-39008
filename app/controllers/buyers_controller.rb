class BuyersController < ApplicationController
  ...
  def buyer_params
    params.require(:buyer_shipping_address).permit(:prefecture_id, :municipality, :address, :building_name, :post_code, :telephone_number, :price).merge(
  ...
  def move_to_toppage
    return if @item.buyer.nil? && current_user.id != @item.user_id
