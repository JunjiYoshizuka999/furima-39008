class BuyerShippingAddress
  ...
  with_options presence: true do
    validates :user_id
    validates :item_id
    validates :post_code, format: { with: /\A[0-9]{3}-[0-9]{4}\z/, message: 'にハイフンを入力してください' }
  ...
  def save
    ...
    ShippingAddress.create(post_code: post_code, prefecture_id: prefecture_id, municipality: municipality,
                           building_name: building_name, telephone_number: telephone_number, address: address, buyer_id: buyer.id)
  end
end
